...
//	public static final String SYNC_EVENTS_URL = HOST + "/mp/prod/php/api/CRRetrieve.php";
	...
	public static final Integer SCHEDULE_DELAY = 1;
	public static final String UNREAD_COLOR = "#D58409";
	public static final Integer RESPONSE_OK = 0;
	public static final String LAST_MANUALLY_UPDATE_DATE = "lastManuallyUpdateDate";
